...
def Panel():
    ...
    table = Table(title="Discord Server Cloner Made By Clubby",show_header=True, header_style="bold")
...
def Panel_Run(guild, user):
    ...
    # Create a table with 2 columns
    table = Table(title="Discord Server Cloner Made By Clubby#1150",show_header=True, header_style="bold")
